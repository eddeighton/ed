...
inline std::ostream& operator<<( std::ostream& os, const Identifier& v )            { OutStream o( os ); o << v; return os; }
inline std::ostream& operator<<( std::ostream& os, const Type& v )                  { OutStream o( os ); o << v; return os; }
inline std::ostream& operator<<( std::ostream& os, const TypeList& v )              { OutStream o( os ); o << v; return os; }
inline std::ostream& operator<<( std::ostream& os, const FileRef& v )               { OutStream o( os ); o << v; return os; }
inline std::ostream& operator<<( std::ostream& os, const Reference& v )             { OutStream o( os ); o << v; return os; }
inline std::ostream& operator<<( std::ostream& os, const Ref& v )                   { OutStream o( os ); o << v; return os; }
inline std::ostream& operator<<( std::ostream& os, const Expression& v )            { OutStream o( os ); o << v; return os; }
inline std::ostream& operator<<( std::ostream& os, const Code& v )                  { OutStream o( os ); o << v; return os; }
inline std::ostream& operator<<( std::ostream& os, const Declarator& v )            { OutStream o( os ); o << v; return os; }
inline std::ostream& operator<<( std::ostream& os, const ArgumentVariant& v )       { OutStream o( os ); o << v; return os; }
inline std::ostream& operator<<( std::ostream& os, const Shorthand& v )             { OutStream o( os ); o << v; return os; }
inline std::ostream& operator<<( std::ostream& os, const TagList& v )               { OutStream o( os ); o << v; return os; }
inline std::ostream& operator<<( std::ostream& os, const Statement& v )             { OutStream o( os ); o << v; return os; }
inline std::ostream& operator<<( std::ostream& os, const Node& v )                  { OutStream o( os ); o << v; return os; }
inline std::ostream& operator<<( std::ostream& os, const EdNode& v )                { OutStream o( os ); o << v; return os; }
inline std::ostream& operator<<( std::ostream& os, const File& v )                  { OutStream o( os ); o << v; return os; }
}
